...
def main():
    ...
    ckpt_path = Path("/home/rasteiger/datasets/dslab/checkpoint/e5_nli_all/adamw/cw_1/bs_16/seed_42/model-epoch=02-train/F1Score=0.79.ckpt")
