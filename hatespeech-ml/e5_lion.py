...
optimizer = Lion
opti_params = {'lr' : learning_rate / 10, 'weight_decay' : 0.1}
...
checkpoint_callback = ModelCheckpoint(
    ...
    filename="e5_lion_train_24-{epoch:02d}-{train/F1Score:.2f}",
    save_weights_only=False,
)

test_writer = CustomWriter(
    write_interval='epoch',
    output_file=data_path + 'outputs/e5_lion_test_preds_24.pkl'
)

expert_writer = CustomWriter(
    write_interval='epoch',
    output_file=data_path + 'outputs/e5_lion_expert_preds_24.pkl'
)
